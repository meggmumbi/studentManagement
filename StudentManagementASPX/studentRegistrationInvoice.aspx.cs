...
{
    public partial class studentRegistrationInvoice : System.Web.UI.Page
    {
        ...
        protected void generate_Click(object sender, EventArgs e)
        {
            ...
            if (!Error)
            {
                try
                {
                    ...
                    String custNumber = invoiceNumber.Text.Trim();
                    String invoiceNo = Request.QueryString["invoiceNo"];

                    String status = new Config().ObjNav().PrintInvoiceInstReg(custNumber, invoiceNo);
        ...
        protected void Unnamed_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("institutionRegistrationPayment.aspx?applicationNo=" + applicationNo + "&&studentNo=" + studentNo);
        }
    }
}