<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="invoice.aspx.cs" Inherits="StudentManagementASPX.invoice" %>
    ...
    %>
      <div class="panel panel-default">
        <div class="panel-heading">
            Invoice<div class="pull-right"><i class="fa fa-angle-left"></i>Step 1 of <%= maxStep %> <i class="fa fa-angle-right"></i></div>
        ...
        <table class="table table-bordered table-striped dataTable">
               ...
               <tbody>
                   <% 
                       ...
                       var details = nav.StudentProcessing.Where(r => r.Approval_Status == "Released" && r.Student_No==studentNo && r.studentType == "New" && r.Created==true);
                   ...
                   <tr>
                       ...
                       <td><a href="invoice.aspx?step=2&&studentNo=<%=detail.Student_No%>&&applicationNo=<%=detail.No %>" class="btn btn-success"><i class="fa fa-eye"></i>View Invoice</a></td>
                   </tr>
                   <%  
                       } %>
               </tbody>
