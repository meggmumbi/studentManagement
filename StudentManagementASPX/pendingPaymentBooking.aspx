<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="pendingPaymentBooking.aspx.cs" Inherits="StudentManagementASPX.pendingPaymentBooking" %>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="example1">
                            ...
                            <tbody>
                                <%
                                    ...
                                    var programs = nav.StudentProcessing.Where(r => r.No == applicationNumber && r.Student_No == studentNumber && r.Document_Type == "Booking" && r.Booking_Invoice_No != null);
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <%
                                        ...
                                        var programss = nav.StudentProcessing.Where(r => r.No == applicationNumber && r.Student_No == studentNumber && r.Document_Type == "Booking" && r.Booking_Receipt_No != null);
                                    ...
                                    <tr>
                                        <th></th>
                                        <td><a href="BookingReceipt.aspx?receiptNo=<%=program.Application_Receipt%>&&applicationNo=<%=program.No %>&&studentNo=<%=program.Student_No %>" class="btn btn-success"><i class="fa fa-eye"></i>View Receipt</a></td>
