...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:TextBox CssClass="form-control" runat="server" ID="regNos" Placeholder="Name"/>
    ...
    <%--        <center>
             ...
             <asp:Button runat="server" ID="savewithdrawal" class="btn btn-primary" text="save deatails" OnClick="savewithdrawal_Click" />
            ...
            <%--<table id="example2" class="table table-bordered table-striped dataTable">
                ...
                <tbody>
                    <% 
                        ...
                        var details = nav.StudentProcessing.Where(r => r.ID_Number_Passport_No == IdNumber && r.Document_Type == "Withdrawal" && r.Approval_Status == "Open");
                    ...
                    <tr>
                        ...
                        <td><a href="Withdrawal.aspx?step=2&&applicationNo=<%=detail.No%>&&courseId=<%=detail.Examination_ID%>" class="btn btn-success"><i class="fa fa-eye"></i>proceed</a></td>
                    </tr>
                    <%  
                        } %>
                </tbody>
            ...
            <asp:Button runat="server" CssClass="btn btn-success pull-right" Text="Next" Id="NextExemption" OnClick="savewithdrawal_Click"/>
            <div class="clearfix"></div>
        </div>
    </div>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <section class="content">
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title">Student Withddrawal</h3>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList runat="server" ID="deffermentType" CssClass="form-control select2" OnSelectedIndexChanged="deffermentType_SelectedIndexChanged" AutoPostBack="True">
                                        ...
                                        <asp:ListItem Value="0">Paper</asp:ListItem>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        <br />
                                        <asp:Button runat="server" CssClass="btn btn-success btn-block" Text=" submit Withdrawal" ID="addItem" OnClick="addItem_Click" />
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <%
                        ...
                        var studentProcessingLine = nav.studentProcessingLines.Where(r => r.Booking_Header_No == applicationNo && r.Document_Type == "Withdrawal");
                    ...
                    <tr>
                       ...
                       <%-- <td><% =line.Section %></td>--%>
                        ...
                        <td><a href="withdrawalSummery.aspx?applicationNo=<%=line.Booking_Header_No%>" class="btn btn-success"><i class="fa fa-eye"></i>Summery</a></td>
                    </tr>
                    <% 
                        }
                    %>
     ...
     <div class="panel-default setup-content" id="step-10">
        ...
        <div class="panel-body">
            ...
            <div class="tab-content">
                         ...
                         <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped custom-table datatable" id="example2">
                                  ...
                                  <div class="panel-footer">
                                    <br />
                                    <input type="button" id="btnSaveWithdrawal" class="btn btn-success pull-left btnSaveWithdrawal" name="btnSaveWithdrawal" value="Submit Documents" />
                                </div>
                                <br />
                                <br />
             ...
             %>
             <asp:Button runat="server" CssClass="btn btn-success pull-right" Text="View Withdrawal Summery" ID="attachdoc" OnClick="attachdoc_Click" Visible="false" />
                </div>
