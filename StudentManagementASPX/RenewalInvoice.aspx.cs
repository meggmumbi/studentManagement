...
{
    public partial class RenewalInvoice : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    string status = new Config().ObjNav().RenewalInvoice(code);
        ...
        protected void PaymentMode_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("Renewal.aspx?step=3&&applicationNo=" + applicationNo);
