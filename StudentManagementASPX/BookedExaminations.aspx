<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="BookedExaminations.aspx.cs" Inherits="StudentManagementASPX.BookedExaminations" %>
            ...
            <div class="col-md-12">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="studentTimetable.aspx?&&application=<%=detail.No%>" class="btn btn-success"><i class="fa fa-eye"></i>Timetable</a></td>
                    </tr>
                    <%  
                        } %>
                </tbody>
