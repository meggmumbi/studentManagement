<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WithdrawalApplications.aspx.cs" Inherits="StudentManagementASPX.WithdrawalApplications" %>
            ...
            <table class="table table-bordered table-striped dataTable" id="example4">
                ...
                <tbody>
                    <% 
                        ...
                        var details = nav.StudentProcessing.Where(r => r.ID_Number_Passport_No == studentNo && r.Document_Type == "Withdrawal");
                    ...
                    <tr>
                        ...
                        %>
                        <td>Withdrawal awaiting processing</td>
                        <%}
                        ...
                        <%}
                            ...
                            {
                        %>
                        <td style="color:green">Withdrawal Approved</td>
                        <%} %>

                        <td><%=detail.Reason_for_Rejection %></td>
                         <td><a href="withdrawalSummery.aspx?applicationNo=<%=detail.No%>" class="btn btn-success"><i class="fa fa-eye"></i>Withdrawal Summery</a></td>
