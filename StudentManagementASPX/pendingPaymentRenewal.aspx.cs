...
{
    public partial class pendingPaymentRenewal : System.Web.UI.Page
    {
        ...
        protected void makePayments_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string status = new Config().ObjNav().ConfirmPaymentsStudent(applicationnumber, paymentsDocUploaded, paymentreference, studentNo, mode);
